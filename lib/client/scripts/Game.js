GAME.screens['game'] = (function () {
    ...
    function swap(blankIndex, i){
        ...
        console.log('Time: ' + slices[i].time);
        if(verify() == true){
            cancelled = true;
    ...
    function run() {
        ...
        for (var t = 0; t < 10; t++){
            ...
            var i = Random.getRandomInteger(factor * factor - 1);
            var up = true, down = true, left = true, right  = true;
    ...
    function sliceImage(img, time){
        ...
        for (var i = 0; i < factor; i++){
            for(var j = 0; j < factor; j++){
                ...
                slices.push({
                    id: factor * i + j,
                    image: img,
                    x: size * j, // these will change with the game
                    y: size * i,
                    subx: size * j,
                    suby: size * i,
                    width: size,
        ...
        //shuffle(slices); // DEBUGGING DISABLED
